...
(function (global) {
  ...
  const DEFAULT_STATE = {
    ...
    projects: [
      ...
      { id: genId('p'), title: 'Portfolio v1.0', description: 'My very first portfolio — designed and coded from scratch to showcase my journey as a junior developer.', stack: ['HTML','CSS'], category: 'Web', github: '#', demo: '#', date: '2026-03', featured: true, order: 0, status: 'published', color: 't1', thumbnail: '', screenshots: [] },
